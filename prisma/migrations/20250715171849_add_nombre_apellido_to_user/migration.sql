...
INSERT INTO "new_User" ("createdAt", "email", "id", "password", "nombre", "apellido", "phone", "role", "status", "updatedAt")
SELECT "createdAt", "email", "id", "password", 'Admin', 'Principal', "phone", "role", "status", "updatedAt" FROM "User";
DROP TABLE "User";
